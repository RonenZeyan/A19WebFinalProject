...
/**
 * this page edit the data of user by the admin like name and phone etc...
 * @returns - a html code of the page including a EditableField component
...
//display the data of user 
    ...
    const handleSubmit = () => {
        ...
        axios.post(`${API_URL}/editUserData/${userID}`,userData)
        .then(response=>{
    ...
    return (
        <div className="user_home h-[100vh] content flex flex-col justify-center items-center py-7">
            <img className='rounded-full bg-white w-[250px] h-[250px] border border-black' src={userData.image?`${API_URL}/${userData.image}`:"\images\iconMan.png"}  alt="mypicture" />
